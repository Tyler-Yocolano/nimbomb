# Resource types in a seperate file for better readability.
# Contains all valid GiantBomb resource types.
...
type
    ResourceType* = enum    
        ...
        rtGame              = "game",
        rtGames             = "games",
        rtGameRating        = "game_rating",
        rtGameRatings       = "game_ratings",
        rtGenre             = "genre",
        rtGenres            = "genres",
        rtImage             = "image",
        rtImages            = "images",
        ...
        rtPromo             = "promo",
        rtPromos            = "promos",
        rtRatingBoard       = "rating_board",
        rtRatingBoards      = "rating_boards",
        rtRegion            = "region",
        rtRegions           = "regions",
        rtRelease           = "release",
        rtReleases          = "releases",
        ...
        rtVideo             = "video",
        rtVideos            = "videos",
        rtVideoCategory     = "video_category",
        rtVideoCategories   = "video_categories",
